...
<footer id="rs-footer" class="bg8 blue-bg rs-footer "
    style="background-image:url(https://nystrings.bishwas.me/wp-content/uploads/2026/06/music-elements.png)!important;">
            ...
            <div class="row footer-contact-desc">
                <div class="col-md-6">
                    <div class="contact-inner">
                        <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg " width="35px"
                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64"
                            enable-background="new 0 0 64 64" xml:space="preserve" fill="#e6695b" stroke="#e6695b">
